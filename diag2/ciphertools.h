...
#include <stdio.h>
	...
	DEV_DEFINE void AES128_128_TDC_CHECK_NUM_ONLY(uint8_t mk[16], uint8_t state[16], int32_t round, double * cpu_time_used1, double * cpu_time_used2, double * cpu_time_used3);
